...
void thunder_franka::set_ddq(const Eigen::VectorXd& ddq_){
...
void thunder_franka::set_d3q(const Eigen::VectorXd& d3q_){
...
void thunder_franka::set_d4q(const Eigen::VectorXd& d4q_){
...
void thunder_franka::set_ddx(const Eigen::VectorXd& ddx_){
...
void thunder_franka::set_par_Mm(const Eigen::VectorXd& par_){
...
Eigen::VectorXd thunder_franka::get_par_Mm(){
	return par_Mm;
}
...
int thunder_franka::save_par(std::string par_file){
	try {
		YAML::Emitter emitter;
		emitter.SetIndent(2);
...
Eigen::MatrixXd thunder_franka::get_C_ddot(){
	Eigen::MatrixXd out;
	out.resize(7,7);
	long long p3[franka_C_ddot_fun_SZ_IW];
	double p4[franka_C_ddot_fun_SZ_W];
	const double* input_[] = {q.data(), dq.data(), ddq.data(), d3q.data(), world2L0.data()};
	double* output_[] = {out.data()};
...
Eigen::MatrixXd thunder_franka::get_C_dot(){
	Eigen::MatrixXd out;
	out.resize(7,7);
	long long p3[franka_C_dot_fun_SZ_IW];
	double p4[franka_C_dot_fun_SZ_W];
...
Eigen::MatrixXd thunder_franka::get_G_ddot(){
	Eigen::MatrixXd out;
	out.resize(7,1);
	long long p3[franka_G_ddot_fun_SZ_IW];
	double p4[franka_G_ddot_fun_SZ_W];
	const double* input_[] = {q.data(), dq.data(), ddq.data(), world2L0.data(), gravity.data()};
	double* output_[] = {out.data()};
...
Eigen::MatrixXd thunder_franka::get_G_dot(){
	Eigen::MatrixXd out;
	out.resize(7,1);
	long long p3[franka_G_dot_fun_SZ_IW];
	double p4[franka_G_dot_fun_SZ_W];
	const double* input_[] = {q.data(), dq.data(), world2L0.data(), gravity.data()};
	double* output_[] = {out.data()};
...
Eigen::MatrixXd thunder_franka::get_J_ee_ddot(){
	Eigen::MatrixXd out;
	out.resize(6,7);
	long long p3[franka_J_ee_ddot_fun_SZ_IW];
	double p4[franka_J_ee_ddot_fun_SZ_W];
...
Eigen::MatrixXd thunder_franka::get_M_ddot(){
	Eigen::MatrixXd out;
	out.resize(7,7);
	long long p3[franka_M_ddot_fun_SZ_IW];
	double p4[franka_M_ddot_fun_SZ_W];
	const double* input_[] = {q.data(), dq.data(), ddq.data(), world2L0.data()};
	double* output_[] = {out.data()};
...
Eigen::MatrixXd thunder_franka::get_M_dot(){
	Eigen::MatrixXd out;
	out.resize(7,7);
	long long p3[franka_M_dot_fun_SZ_IW];
	double p4[franka_M_dot_fun_SZ_W];
	const double* input_[] = {q.data(), dq.data(), world2L0.data()};
	double* output_[] = {out.data()};
...
PYBIND11_MODULE(thunder_franka_py, m) {
	py::class_<thunder_franka>(m, "thunder_franka")
		.def(py::init<>())
		.def("resizeVariables", &thunder_franka::resizeVariables)
		.def("setArguments", &thunder_franka::setArguments, "Set q, dq, dqr, ddqr", py::arg("q"), py::arg("dq"), py::arg("dqr"), py::arg("ddqr"))
		.def("set_q", &thunder_franka::set_q, "Set q", py::arg("q"))
		.def("set_dq", &thunder_franka::set_dq, "Set dq", py::arg("dq"))
		.def("set_dqr", &thunder_franka::set_dqr, "Set dqr", py::arg("dqr"))
		.def("set_ddqr", &thunder_franka::set_ddqr, "Set ddqr", py::arg("ddqr"))
		.def("set_par_REG", &thunder_franka::set_par_REG, "Set inertial parameters REG", py::arg("par"), py::arg("update_DYN") = true)
		.def("set_par_DYN", &thunder_franka::set_par_DYN, "Set inertial parameters DYN", py::arg("par"), py::arg("update_REG") = true)
		.def("get_par_REG", &thunder_franka::get_par_REG, "Get par parameters REG")
		.def("get_par_DYN", &thunder_franka::get_par_DYN, "Get inertial parameters DYN")
		.def("load_par_REG", &thunder_franka::load_par_REG, "Load par parameters REG from YAML file", py::arg("file_path"), py::arg("update_DYN") = true)
		.def("load_conf", &thunder_franka::load_conf, "Load configuration from YAML file", py::arg("file_path"), py::arg("update_REG") = true)
		.def("save_par_REG", &thunder_franka::save_par_REG, "Save par parameters REG to YAML file", py::arg("file_path"))
		.def("save_par_DYN", &thunder_franka::save_par_DYN, "Save inertial parameters DYN to YAML file", py::arg("file_path"))
		.def("get_numJoints", &thunder_franka::get_numJoints, "Get number of joints")
		.def("get_numParDYN", &thunder_franka::get_numParDYN, "Get number of parameters per link")
		.def("get_numParREG", &thunder_franka::get_numParREG, "Get number of parameters")
		...
		.def("get_T_0", &thunder_franka::get_T_0, "relative transformation from frame base to frame 1")
		.def("get_T_0_0", &thunder_franka::get_T_0_0, "absolute transformation from frame base to frame 1")
		.def("get_T_0_1", &thunder_franka::get_T_0_1, "absolute transformation from frame base to frame 1")
		.def("get_T_0_2", &thunder_franka::get_T_0_2, "absolute transformation from frame base to frame 2")
		.def("get_T_0_3", &thunder_franka::get_T_0_3, "absolute transformation from frame base to frame 3")
		.def("get_T_0_4", &thunder_franka::get_T_0_4, "absolute transformation from frame base to frame 4")
		.def("get_T_0_5", &thunder_franka::get_T_0_5, "absolute transformation from frame base to frame 5")
		.def("get_T_0_6", &thunder_franka::get_T_0_6, "absolute transformation from frame base to frame 6")
		.def("get_T_0_7", &thunder_franka::get_T_0_7, "absolute transformation from frame base to frame 7")
		.def("get_T_0_8", &thunder_franka::get_T_0_8, "absolute transformation from frame base to end_effector")
		.def("get_T_0_ee", &thunder_franka::get_T_0_ee, "absolute transformation from frame 0 to end_effector")
