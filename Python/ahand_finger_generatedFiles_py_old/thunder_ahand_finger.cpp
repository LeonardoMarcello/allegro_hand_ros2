...
PYBIND11_MODULE(thunder_ahand_finger_py, m) {
	py::class_<thunder_ahand_finger>(m, "thunder_ahand_finger")
		.def(py::init<>())
		.def("resizeVariables", &thunder_ahand_finger::resizeVariables)
		.def("setArguments", &thunder_ahand_finger::setArguments, "Set q, dq, dqr, ddqr", py::arg("q"), py::arg("dq"), py::arg("dqr"), py::arg("ddqr"))
		.def("set_q", &thunder_ahand_finger::set_q, "Set q", py::arg("q"))
		.def("set_dq", &thunder_ahand_finger::set_dq, "Set dq", py::arg("dq"))
		.def("set_dqr", &thunder_ahand_finger::set_dqr, "Set dqr", py::arg("dqr"))
		.def("set_ddqr", &thunder_ahand_finger::set_ddqr, "Set ddqr", py::arg("ddqr"))
		.def("set_par_REG", &thunder_ahand_finger::set_par_REG, "Set inertial parameters REG", py::arg("par"), py::arg("update_DYN") = true)
		.def("set_par_DYN", &thunder_ahand_finger::set_par_DYN, "Set inertial parameters DYN", py::arg("par"), py::arg("update_REG") = true)
		.def("get_par_REG", &thunder_ahand_finger::get_par_REG, "Get par parameters REG")
		.def("get_par_DYN", &thunder_ahand_finger::get_par_DYN, "Get inertial parameters DYN")
		.def("load_par_REG", &thunder_ahand_finger::load_par_REG, "Load par parameters REG from YAML file", py::arg("file_path"), py::arg("update_DYN") = true)
		.def("load_conf", &thunder_ahand_finger::load_conf, "Load configuration from YAML file", py::arg("file_path"), py::arg("update_REG") = true)
		.def("save_par_REG", &thunder_ahand_finger::save_par_REG, "Save par parameters REG to YAML file", py::arg("file_path"))
		.def("save_par_DYN", &thunder_ahand_finger::save_par_DYN, "Save inertial parameters DYN to YAML file", py::arg("file_path"))
		.def("get_numJoints", &thunder_ahand_finger::get_numJoints, "Get number of joints")
		.def("get_numParDYN", &thunder_ahand_finger::get_numParDYN, "Get number of parameters per link")
		.def("get_numParREG", &thunder_ahand_finger::get_numParREG, "Get number of parameters")
		...
		.def("get_T_0", &thunder_ahand_finger::get_T_0, "relative transformation from frame base to frame 1")
		.def("get_T_0_0", &thunder_ahand_finger::get_T_0_0, "absolute transformation from frame base to frame 1")
		.def("get_T_0_1", &thunder_ahand_finger::get_T_0_1, "absolute transformation from frame base to frame 1")
		.def("get_T_0_2", &thunder_ahand_finger::get_T_0_2, "absolute transformation from frame base to frame 2")
		.def("get_T_0_3", &thunder_ahand_finger::get_T_0_3, "absolute transformation from frame base to frame 3")
		.def("get_T_0_4", &thunder_ahand_finger::get_T_0_4, "absolute transformation from frame base to frame 4")
		.def("get_T_0_5", &thunder_ahand_finger::get_T_0_5, "absolute transformation from frame base to end_effector")
		.def("get_T_0_ee", &thunder_ahand_finger::get_T_0_ee, "absolute transformation from frame 0 to end_effector")
